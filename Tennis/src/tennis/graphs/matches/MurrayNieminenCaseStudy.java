...
public class MurrayNieminenCaseStudy
{
	...
	{
		final ReadMatch marketChart = new ReadMatch(213, 3, "doc\\murraynieminen.csv",
	    ...
	    final RiskChart riskChart = new RiskChart("Andy Murray", "Murray", "Niemenen", marketChart.pointLevelRisks, marketChart.risks);
