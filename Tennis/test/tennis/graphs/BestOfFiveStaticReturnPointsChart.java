...
public class BestOfFiveStaticReturnPointsChart extends XYLineChart
{
	public BestOfFiveStaticReturnPointsChart() throws IOException
	{
	...
	{
	    final BestOfFiveStaticReturnPointsChart chart = new BestOfFiveStaticReturnPointsChart();
	    chart.buildChart();
	    chart.pack();
