...
public class MurrayBerrerSmooth
{
	public static void main(final String[] args) throws IOException
	{
		final OddsChart chart = new SmoothOddsChart(new PlayerOdds("Andy Murray", "treatment\\five", "Murray vs Berrer - French Open 2011 Third Round"),
